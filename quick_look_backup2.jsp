													...
													<%
														...
														for(PortBean pb:pbli)
														{
															if(((Integer.parseInt(pb.getInneridname()) >= 10 && Integer.parseInt(pb.getInneridname()) <= 19) || (Integer.parseInt(pb.getInneridname()) >= 51 && Integer.parseInt(pb.getInneridname()) <= 53))) {
																...
																//<li class="quick-look" class="text-right">
																%>
																<li class="text-right" style="padding: 5px 0px 0px 0px;">
																	<span class="col-md-6 col-sm-12 col-xs-12">
																		...
																		%>		
																				<span class="col-md-4" style="color:red;">
																					<%=String.format("% 3d \t/ % 3d",pb.getAmount(), pb.getCapacity()) %>
																				</span> 	
																		<%
																			}else {
																		%>																																			
																				<span class="col-md-4" style="color:green;">
																					<%=String.format("% 3d \t/ % 3d",pb.getAmount(), pb.getCapacity()) %>
																				</span> 																			
																		<%
																			}
